...
public class FAQActivity extends AppCompatActivity {
    ...
    private void initialization() {
        mWebView = (WebView) findViewById(R.id.wb_FAQ);
        ...
        mWebView.loadUrl("http://projects-beta.com/noan/webservices/user/faq");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem bedMenuItem = menu.findItem(R.id.btnSave);
        bedMenuItem.setTitle("Contact");
