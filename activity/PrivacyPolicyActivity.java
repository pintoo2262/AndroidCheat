...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    private void initialization() {
        ...
        mWebView = (WebView) findViewById(R.id.wb_privacy);
        ...
        mWebView.loadUrl("http://projects-beta.com/noan/webservices/user/privacyPolicy");
    ...
    private void toolBarAndDrawerInitilization() {
        ...
        mToolbarTitle.setText(getResources().getString(R.string.privacyTitle));
    }
