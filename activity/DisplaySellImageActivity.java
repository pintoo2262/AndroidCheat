...
public class DisplaySellImageActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = DisplaySellImageActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displaimage);
        prefs = this.getSharedPreferences("yourPrefsKey", Context.MODE_PRIVATE);
        mProduct = (Productdatum) getIntent().getSerializableExtra("Productdatum");
        ...
        rvProductImage.addOnItemTouchListener(new RecyclerTouchListener(this, rvProductImage, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                Intent intent = new Intent(DisplaySellImageActivity.this, LargeView.class);
    ...
    private void initialize() {
        ...
        txtProductTitle.setText(mProduct.getProductName());
        txtProductPrice.setText("$ " + mProduct.getPrice());
        txtProductCondtion.setText("Box :" + mProduct.getBoxCondition());
        ...
        if (sizeModelList.size() > 0) {
            for (int i = 0; i < sizeModelList.size(); i++) {
                if (mProduct.getSize().equals(sizeModelList.get(i).getSizeId())) {
        ...
        Glide.with(this).load(mProduct.getProductMainImage())
    ...
    private void displyAllImage_byServer() {
        pDialog = new Dialog(DisplaySellImageActivity.this);
        ...
        credMap.put("user_product_detail_id", mProduct.getUserProductDetailId());
            ...
            public void onResponse(Call<DisplayImageResponse> call, Response<DisplayImageResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (displayImageResponse.getStatus() == 1) {
                        ...
                        tempProductImageList.add(mProduct.getProductMainImage());
...
//                        Toast.makeText(DisplaySellImageActivity.this, "" + displayImageResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<DisplayImageResponse> call, Throwable t) {
                ...
                call.cancel();
                Toast.makeText(DisplaySellImageActivity.this, "Please check your network connection and internet permission" + t.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_ListingImage:
                Intent mintent = new Intent(DisplaySellImageActivity.this, LargeView.class);
