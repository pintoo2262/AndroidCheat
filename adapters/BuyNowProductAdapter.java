...
import com.app.noan.fragment.BuynowFragment;
...
public class BuyNowProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BuynowFragment mCallback;

    private String errorMsg;
    private GridLayoutManager mManager;

    public BuyNowProductAdapter(FragmentActivity activity, BuynowFragment buynowFragment, RecyclerView rv_product) {
        this.context = activity;
        this.mCallback = buynowFragment;
    ...
    public BuyNowProductAdapter(SearchCategoryActivity searchCategoryActivity, RecyclerView rv_categoryProduct) {
