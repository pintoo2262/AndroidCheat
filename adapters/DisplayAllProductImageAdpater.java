...
public class DisplayAllProductImageAdpater extends RecyclerView.Adapter<DisplayAllProductImageAdpater.ProductItemHolder> {

    Activity activity;
    List<Imagedatum> imagedatumList;


    public DisplayAllProductImageAdpater(Activity activity, List<Imagedatum> productImageList) {
