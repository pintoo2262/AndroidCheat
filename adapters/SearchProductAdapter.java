...
import com.app.noan.activity.SearchSaleActivity;
...
public class SearchProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private String errorMsg, screenName;
    private GridLayoutManager mManager;


    public SearchProductAdapter(FragmentActivity activity, SearchFragment searchFragment, RecyclerView rv_searchBySku) {
        this.context = activity;
        this.productModelList = new ArrayList<>();
        mCallback = (PaginationAdapterCallback) searchFragment;
        this.mManager = (GridLayoutManager) rv_searchBySku.getLayoutManager();
    ...
    public SearchProductAdapter(SearchSaleActivity searchSaleActivity, RecyclerView rvSearchResult, String screenName) {
        this.context = searchSaleActivity;
        this.productModelList = new ArrayList<>();
        mCallback = (PaginationAdapterCallback) context;
        this.mManager = (GridLayoutManager) rvSearchResult.getLayoutManager();
        mManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            @Override
            public int getSpanSize(int position) {
                return getItemViewType(position) == LOADING ? mManager.getSpanCount() : 1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.layout_rv_sandal_sku, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                if (screenName != null) {
                    itemViewHolder.llPrice.setVisibility(View.INVISIBLE);
                } else {
