...
import com.app.noan.fragment.ExclusiveFragment;
...
public class ExclusiveProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public List<Product> exclusiveProductList;
    ...
    public List<Product> getExclusiveProductList() {
        return exclusiveProductList;
    }

    public void setExclusiveProductList(List<Product> exclusiveProductList) {
        this.exclusiveProductList = exclusiveProductList;
    }

    public ExclusiveProductAdapter(FragmentActivity activity, ExclusiveFragment exclusiveFragment, RecyclerView rv_exclusive) {
        this.context = activity;
        this.mCallback = (PaginationAdapterCallback) exclusiveFragment;
        this.exclusiveProductList = new ArrayList<>();
        productSearchList = new ArrayList<>();
        this.mManager = (GridLayoutManager) rv_exclusive.getLayoutManager();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        Product product = exclusiveProductList.get(position);
    ...
    public int getItemCount() {
        return exclusiveProductList == null ? 0 : exclusiveProductList.size();
    }

    @Override
    public int getItemViewType(int position) {
        return (position == exclusiveProductList.size() - 1 && isLoadingAdded) ? LOADING : ITEM;
    }
    ...
    */
    ...
    public void add(Product r) {
        exclusiveProductList.add(r);
        notifyItemInserted(exclusiveProductList.size() - 1);
    }
    ...
    public void remove(Product r) {
        int position = exclusiveProductList.indexOf(r);
        if (position > -1) {
            exclusiveProductList.remove(position);
    ...
    public void removeLoadingFooter() {
        ...
        if (exclusiveProductList.size() > 0) {
            int position = exclusiveProductList.size() - 1;
    ...
    public Product getItem(int position) {
        return exclusiveProductList.get(position);
    }
    ...
    public void showRetry(boolean show, @Nullable String errorMsg) {
        retryPageLoad = show;
        notifyItemChanged(exclusiveProductList.size() - 1);
