...
import com.app.noan.AnimatedIndicatorInterface;

/**
 * Created by Andy671
 */

public class PointMoveIndicator implements AnimatedIndicatorInterface, ObjectAnimator.AnimatorUpdateListener{
    ...
    public PointMoveIndicator(DachshundTabLayout dachshundTabLayout) {
        ...
        valueAnimator.setDuration(AnimatedIndicatorInterface.DEFAULT_DURATION);
    ...
    public void draw(Canvas canvas) {
        canvas.drawCircle(frameX, (float) canvas.getHeight(), (float) (height/1), paint);
    }
